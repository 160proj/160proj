...
class TestSim:
    ...
    def closeClient(self, client_address, dest, srcPort, destPort):
        self.sendCMD(self.CMD_CLOSE_CLIENT, client_address, "{0}{1}{2}".format(chr(dest), chr(srcPort), chr(destPort)))
